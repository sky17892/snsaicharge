...
# ---------------------------------------------------------------------------
# 콘텐츠 기획: 1~5편 사용법 안내 + 6~20편 에피소드·스토리형 (총 20편)
...
def build_system_prompt():
    return (
        ...
        "[매우 중요: 편마다 다른 내용]\n"
        "같은 배치 안의 여러 편이라도 hook, body_narration, closing_line, title, screen_guide는 "
        "서로 겹치지 않는 완전히 다른 구체적 내용이어야 합니다. "
        "문장 구조나 표현을 복제해 편명만 바꾸는 식의 템플릿 반복은 금지합니다. "
        "같은 주제 안에서도 다른 상황, 다른 사례, 다른 접근 각도로 작성하세요.\n\n"
        ...
        "[사용법 안내 영상 전용 지침 (content_type이 '사용법 안내'인 경우, video_id 1~5)]\n"
        ...
        "- 5편은 각각 서로 다른 절차(회원가입, 정보입력, 결과확인, 결제, 재이용/알림)를 다루므로 "
        "내용이 절대 겹치면 안 됩니다.\n\n"

        "[에피소드·스토리형 영상 전용 지침 (content_type이 '에피소드·스토리형'인 경우, video_id 6~20)]\n"
        ...
        "- 같은 주제(topic) 배치 안에서도 등장인물의 구체적 상황, 나이대, 고민 포인트를 다르게 설정해 "
        "3편이 서로 다른 이야기가 되도록 하세요.\n\n"
